...
tl_admin_users = ['JAGB2021', '', ''] #Poner aqui los user con acceso permanente
godlist = ['JAGB2021', '', ''] #Poner aqui los admin 
...
async def onmessage(bot:TelegramClient,ev: NewMessage.Event,loop,ret=False):
    ...
    if '/start' in text:
        ...
        reply += '<a href="𝖍𝖙𝖙𝖕𝖘://𝖌𝖎𝖙𝖍𝖚𝖇.𝖈𝖔𝖒/reymichel2009�">𝕲𝖎𝖙𝖍𝖚𝖇</a>\n'
